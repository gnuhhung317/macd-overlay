...
class StrategyConfig(BaseModel):
    ...
    model_mode: str = "auto038_selector"
    profile_path: str = "ml/p3_edge_research/experiments/auto_038_live_test.json"
    profile_name: str = "auto_038_live"
    selector_artifact_path: str = "output/selector_artifacts/auto_038_debug_policy_fullasset.joblib"
    ...
    carry_setup_bars: int = 0
    carry_require_fill: bool = True
